...
import { GeneratorOptions, GeneratorContext, GeneratorResult, GeneratorSchema } from '../../core/interfaces';
import { openAPIToolsGeneratorSchema } from './schema';
import { buildCommandArgs } from '../../../executors/generate-api/utils/build-command';
import { GenerateApiExecutorSchema } from '../../../executors/generate-api/schema';
...
export class OpenAPIToolsGenerator extends BaseGenerator {
   ...
   */
  protected validateCustomOptions(_options: GeneratorOptions): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
